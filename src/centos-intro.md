...
cat file | more                     # 查看文件
ps -ef | grep java                  # 显示当前带有java的活动进程
...
netstat -tunlp | grep 9999          # 查找所有监听端口为9999的进程信息
lsof -i 9999                        # 查看端口为9999的进程
top                                 # 实时动态刷新的系统状态视图
tail -f /var/log/nginx/access.log   # 实时动态查看nginx访问日志最后10行
nohup java -jar app.jar &           # 后台运行app.jar应用
```
