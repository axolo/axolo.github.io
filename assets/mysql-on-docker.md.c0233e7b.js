import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.d5af2850.js";const m=JSON.parse('{"title":"MySQL on Docker","description":"把 MySQL 部署到 Docker 上，不失为一个很好的选择。","frontmatter":{"title":"MySQL on Docker","time":"2021-06-18T00:00:00.000Z","description":"把 MySQL 部署到 Docker 上，不失为一个很好的选择。","category":"数据库","tags":["MySQL","Docker","Linux","Shell"]},"headers":[],"relativePath":"mysql-on-docker.md","filePath":"mysql-on-docker.md"}'),p={name:"mysql-on-docker.md"},o=l(`<h1 id="mysql-on-docker" tabindex="-1">MySQL on Docker <a class="header-anchor" href="#mysql-on-docker" aria-label="Permalink to &quot;MySQL on Docker&quot;">​</a></h1><blockquote><p>方跃明 2021-06-18</p></blockquote><p>把 MySQL 部署到 Docker 上不失为一个很好的选择。</p><h2 id="install" tabindex="-1">Install <a class="header-anchor" href="#install" aria-label="Permalink to &quot;Install&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/bin/bash</span></span>
