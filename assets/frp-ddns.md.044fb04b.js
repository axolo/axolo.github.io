import{_ as s,o as n,c as a,g as l}from"./app.5dd13a44.js";const D=JSON.parse('{"title":"家用宽带联机开发环境部署","description":"利用家庭宽带低成本、低功耗部署联机开发环境。当然，若有阿里云等公网环境，路由服务器合一，略改即可支持。","frontmatter":{"title":"家用宽带联机开发环境部署","description":"利用家庭宽带低成本、低功耗部署联机开发环境。当然，若有阿里云等公网环境，路由服务器合一，略改即可支持。","time":"2020-05-18T00:00:00.000Z","category":"运维","tags":["Linux","CentOS","内网穿透"]},"headers":[{"level":2,"title":"条件","slug":"条件","link":"#条件","children":[]},{"level":2,"title":"思路","slug":"思路","link":"#思路","children":[]},{"level":2,"title":"frps","slug":"frps","link":"#frps","children":[]},{"level":2,"title":"frpc server","slug":"frpc-server","link":"#frpc-server","children":[]},{"level":2,"title":"frpc developer","slug":"frpc-developer","link":"#frpc-developer","children":[]},{"level":2,"title":"端口映射","slug":"端口映射","link":"#端口映射","children":[]},{"level":2,"title":"客户托管","slug":"客户托管","link":"#客户托管","children":[{"level":3,"title":"开发版","slug":"开发版","link":"#开发版","children":[]},{"level":3,"title":"静态页","slug":"静态页","link":"#静态页","children":[]}]},{"level":2,"title":"Ngrok","slug":"ngrok","link":"#ngrok","children":[]}],"relativePath":"frp-ddns.md"}'),p={name:"frp-ddns.md"},o=l(`<h1 id="家用宽带联机开发环境部署" tabindex="-1">家用宽带联机开发环境部署 <a class="header-anchor" href="#家用宽带联机开发环境部署" aria-hidden="true">#</a></h1><blockquote><p>方跃明 2020-05-18</p></blockquote><p>利用家庭宽带低成本、低功耗部署联机开发环境。 当然，若有阿里云等公网环境，路由服务器合一，略改即可支持。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">                  +-----------+</span></span>
...
<span class="line"></span></code></pre></div><h2 id="frpc-server" tabindex="-1">frpc server <a class="header-anchor" href="#frpc-server" aria-hidden="true">#</a></h2><p>服务器端配置，建议安装为服务</p><div class="language-ini"><button title="Copy Code" class="copy"></button><span class="lang">ini</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">[common]</span></span>
...
<span class="line"><span style="color:#F07178;">local_port</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> 80</span></span>
<span class="line"><span style="color:#F07178;">proxy_protocol_version</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> v2</span></span>
<span class="line"></span></code></pre></div><h2 id="frpc-developer" tabindex="-1">frpc developer <a class="header-anchor" href="#frpc-developer" aria-hidden="true">#</a></h2><p>开发机端配置，建议命令行运行</p><div class="language-ini"><button title="Copy Code" class="copy"></button><span class="lang">ini</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">[common]</span></span>
<span class="line"><span style="color:#F07178;">server_addr</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> frps-server-host</span></span>
<span class="line"><span style="color:#F07178;">server_port</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> 7000</span></span>
<span class="line"><span style="color:#F07178;">token</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> your-token</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#F07178;">proxy_protocol_version</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> v2</span></span>
<span class="line"></span></code></pre></div><h2 id="端口映射" tabindex="-1">端口映射 <a class="header-anchor" href="#端口映射" aria-hidden="true">#</a></h2><p>在路由器上配置端口映射开放外网访问。</p><h2 id="客户托管" tabindex="-1">客户托管 <a class="header-anchor" href="#客户托管" aria-hidden="true">#</a></h2><h3 id="开发版" tabindex="-1">开发版 <a class="header-anchor" href="#开发版" aria-hidden="true">#</a></h3><p>客户域名解析添加<code>CNAME</code>到服务器端相应的域名，并使用<code>nginx</code>反向代理。</p><h3 id="静态页" tabindex="-1">静态页 <a class="header-anchor" href="#静态页" aria-hidden="true">#</a></h3><p>使用<code>Pages</code>服务，可支持<code>HTTPS</code>（涉及跨域谨慎使用）。</p><h2 id="ngrok" tabindex="-1">Ngrok <a class="header-anchor" href="#ngrok" aria-hidden="true">#</a></h2><p><a href="https://baike.baidu.com/item/ngrok/13986278" target="_blank" rel="noreferrer">Ngrok</a> 释义</p>`,25),e=[o];function t(r,c,i,y,C,d){return n(),a("div",null,e)}const F=s(p,[["render",t]]);export{D as __pageData,F as default};
