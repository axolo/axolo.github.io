import{_ as s,o as n,c as a,a as l}from"./app.14423192.js";const h=JSON.parse('{"title":"Linux 目录结构","description":"掌握一个操作系统，从它的目录结构开始，啥东西一般放哪得心知肚明。","frontmatter":{"title":"Linux 目录结构","description":"掌握一个操作系统，从它的目录结构开始，啥东西一般放哪得心知肚明。","time":"2021-12-19T00:00:00.000Z","category":"运维","tags":["CentOS","Linux"]},"headers":[{"level":2,"title":"目录结构","slug":"目录结构","link":"#目录结构","children":[]},{"level":2,"title":"系统服务","slug":"系统服务","link":"#系统服务","children":[]},{"level":2,"title":"启动顺序","slug":"启动顺序","link":"#启动顺序","children":[]}],"relativePath":"linux-directory.md"}'),e={name:"linux-directory.md"},p=l(`<h1 id="linux目录结构" tabindex="-1">Linux目录结构 <a class="header-anchor" href="#linux目录结构" aria-hidden="true">#</a></h1><blockquote><p>方跃明 2021-12-19</p></blockquote><p>Linux目录树的主要部分有<code>/</code>、<code>/usr</code>、<code>/var</code>、<code>/home</code>等等。 下面是一个典型的Linux目录结构如下：</p><h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">\`-- /               # 根目录</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="系统服务" tabindex="-1">系统服务 <a class="header-anchor" href="#系统服务" aria-hidden="true">#</a></h2><p>系统服务目录位于：<code>/usr/lib/systemd/system</code></p><h2 id="启动顺序" tabindex="-1">启动顺序 <a class="header-anchor" href="#启动顺序" aria-hidden="true">#</a></h2><p>Linux会按以下顺序读取4个环境配置文件：</p><ol><li><code>/etc/profile</code>：所有用户登录时均执行此脚本</li><li><code>/etc/bashrc</code>：所有用户运行<code>bash shell</code>时均执行此脚本</li><li><code>~/.profile</code>：当前户登录时执行此脚本</li><li><code>~/.bashrc</code>：当前用户运行<code>bash shell</code>时执行此脚本</li></ol>`,10),c=[p];function o(i,t,r,C,A,d){return n(),a("div",null,c)}const D=s(e,[["render",o]]);export{h as __pageData,D as default};
