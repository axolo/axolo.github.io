import{_ as s,o as a,c as n,b as l}from"./app.64d60b05.js";const F=JSON.parse('{"title":"MySQL on Docker","description":"把 MySQL 部署到 Docker 上，不失为一个很好的选择。","frontmatter":{"title":"MySQL on Docker","time":"2021-06-18T00:00:00.000Z","description":"把 MySQL 部署到 Docker 上，不失为一个很好的选择。","categories":["sql"],"tags":["MySQL","Docker","Linux","Shell"]},"relativePath":"mysql-on-docker.md","lastUpdated":1673684899000}'),p={name:"mysql-on-docker.md"},o=l(`<h1 id="mysql-on-docker" tabindex="-1">MySQL on Docker <a class="header-anchor" href="#mysql-on-docker" aria-hidden="true">#</a></h1><p>把 MySQL 部署到 Docker 上不失为一个很好的选择。</p><h2 id="install" tabindex="-1">Install <a class="header-anchor" href="#install" aria-hidden="true">#</a></h2><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">#!/bin/bash</span></span>
...
<span class="line"></span></code></pre></div>`,8),e=[o];function t(c,r,y,i,D,C){return a(),n("div",null,e)}const d=s(p,[["render",t]]);export{F as __pageData,d as default};
