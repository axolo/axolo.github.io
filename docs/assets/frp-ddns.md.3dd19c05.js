import{_ as s,o as a,c as n,b as p}from"./app.0279b585.js";const d=JSON.parse('{"title":"家用宽带联机开发环境部署","description":"","frontmatter":{"title":"家用宽带联机开发环境部署","time":"2020-05-18T00:00:00.000Z","categories":"Linux","tags":["Linux","CentOS","内网穿透"]},"relativePath":"frp-ddns.md","lastUpdated":1673342895000}'),l={name:"frp-ddns.md"},o=p(`<h1 id="家用宽带联机开发环境部署" tabindex="-1">家用宽带联机开发环境部署 <a class="header-anchor" href="#家用宽带联机开发环境部署" aria-hidden="true">#</a></h1><p>利用家庭宽带低成本、低功耗部署联机开发环境。 当然，若有阿里云等公网环境，路由服务器合一，略改即可支持。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">                  +-----------+</span></span>
