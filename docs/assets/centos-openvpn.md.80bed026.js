import{_ as a,o as l,c as p,b as e,a as s,r as o}from"./app.33a46d54.js";const h=JSON.parse('{"title":"CentOS安装配置OpenVPN","description":"","frontmatter":{"title":"CentOS安装配置OpenVPN","time":"2020-01-29T00:00:00.000Z","categories":"CentOS","tags":["CentOS","Linux","OpenVPN"]},"relativePath":"centos-openvpn.md","lastUpdated":1673246413000}'),t={name:"centos-openvpn.md"},c=s('<h1 id="centos安装配置openvpn" tabindex="-1">CentOS安装配置OpenVPN <a class="header-anchor" href="#centos安装配置openvpn" aria-hidden="true">#</a></h1><blockquote><p>环境</p></blockquote><table><thead><tr><th>环境</th><th>版本</th><th>说明</th></tr></thead><tbody><tr><td>CentOS</td><td>el8</td><td>兼容el7</td></tr><tr><td>easy-rsa</td><td>3.0.6-1.el7</td><td></td></tr><tr><td>openvpn</td><td>2.4.8-1.el7</td><td></td></tr></tbody></table><blockquote><p>流程</p></blockquote>',4),r=s(`<h2 id="安装依赖" tabindex="-1">安装依赖 <a class="header-anchor" href="#安装依赖" aria-hidden="true">#</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">dnf</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">install</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">net-tools</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="配置easy-rsa" tabindex="-1">配置easy-rsa <a class="header-anchor" href="#配置easy-rsa" aria-hidden="true">#</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">cp</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-r</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/usr/share/easy-rsa/3.0.6/</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/easy-rsa/</span></span>
...
<span class="line"></span></code></pre></div><h2 id="服务端" tabindex="-1">服务端 <a class="header-anchor" href="#服务端" aria-hidden="true">#</a></h2><h3 id="创建pki、ca、证书、密钥" tabindex="-1">创建PKI、CA、证书、密钥 <a class="header-anchor" href="#创建pki、ca、证书、密钥" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/easy-rsa</span></span>
...
<span class="line"></span></code></pre></div><h3 id="整理密钥和证书" tabindex="-1">整理密钥和证书 <a class="header-anchor" href="#整理密钥和证书" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/certs/server</span></span>
...
<span class="line"></span></code></pre></div><h2 id="证书客户端" tabindex="-1">证书客户端 <a class="header-anchor" href="#证书客户端" aria-hidden="true">#</a></h2><p>多个客户端请自行重复以下操作</p><h3 id="创建证书和密钥" tabindex="-1">创建证书和密钥 <a class="header-anchor" href="#创建证书和密钥" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/easy-rsa</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">### 创建服务端证书和密钥</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;"># Type the word &#39;yes&#39; to continue, or any other input to abort.</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#  Confirm request details: yes # 输入yes回车</span></span>
<span class="line"></span></code></pre></div><h3 id="整理证书和密钥" tabindex="-1">整理证书和密钥 <a class="header-anchor" href="#整理证书和密钥" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/certs/client/user01</span></span>
<span class="line"><span style="color:#FFCB6B;">cp</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/easy-rsa/ta.key</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">.</span></span>
<span class="line"><span style="color:#FFCB6B;">cp</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/easy-rsa/pki/ca.crt</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">&lt;/key&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="密码客户端" tabindex="-1">密码客户端 <a class="header-anchor" href="#密码客户端" aria-hidden="true">#</a></h2><h3 id="用户认证脚本" tabindex="-1">用户认证脚本 <a class="header-anchor" href="#用户认证脚本" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">#!/bin/sh</span></span>
...
<span class="line"></span></code></pre></div><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 赋予可执行权限</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="用户固定ip配置" tabindex="-1">用户固定IP配置 <a class="header-anchor" href="#用户固定ip配置" aria-hidden="true">#</a></h3><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">vi</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/openvpn/client/user1</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><blockquote><p><code>ifconfig-push</code>中的每一对IP地址表示虚拟客户端和服务器的IP端点。它们必须从连续的/30子网网段中获取(这里是/30表示xxx.xxx.xxx.xxx/30，即子网掩码位数为30)，以便于与Windows客户端和TAP-Windows驱动兼容。明确地说，每个端点的IP地址对的最后8位字节必须取自下面的集合：</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">[1, 2]    [5, 6]    [9, 10]   [ 13, 14] [ 17, 18]</span></span>
