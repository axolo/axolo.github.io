import{_ as s,o as a,c as n,a as p}from"./app.3ad48a2f.js";const u=JSON.parse('{"title":"Git排除忽略子目录","description":"","frontmatter":{"title":"Git排除忽略子目录","time":"2019-09-09T00:00:00.000Z","layout":"post","categories":"Git","tags":["Git"]},"headers":[{"level":2,"title":"示例","slug":"示例","link":"#示例","children":[]}],"relativePath":"git-ignore-exclude.md","lastUpdated":1673246413000}'),l={name:"git-ignore-exclude.md"},e=p(`<h1 id="git排除忽略子目录" tabindex="-1">Git排除忽略子目录 <a class="header-anchor" href="#git排除忽略子目录" aria-hidden="true">#</a></h1><p>想忽略某个目录，但又不想忽略这个目录下的某个子目录？</p><p>排除此目录，改为忽略*，然后忽略子目录。</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;"># exclude ignore cn</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><blockquote><p>方跃明 2019-09-09</p></blockquote>`,9),c=[e];function t(o,i,r,C,A,d){return a(),n("div",null,c)}const D=s(l,[["render",t]]);export{u as __pageData,D as default};
