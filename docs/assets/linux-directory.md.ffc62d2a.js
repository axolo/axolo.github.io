import{_ as s,o as n,c as a,g as l}from"./app.5487b0bb.js";const h=JSON.parse('{"title":"Linux 目录结构","description":"掌握一个操作系统，从它的目录结构开始，啥东西一般放哪得心知肚明。","frontmatter":{"title":"Linux 目录结构","description":"掌握一个操作系统，从它的目录结构开始，啥东西一般放哪得心知肚明。","time":"2021-12-19T00:00:00.000Z","category":"运维","tags":["CentOS","Linux"]},"headers":[{"level":2,"title":"目录结构","slug":"目录结构","link":"#目录结构","children":[]},{"level":2,"title":"系统服务","slug":"系统服务","link":"#系统服务","children":[]},{"level":2,"title":"启动顺序","slug":"启动顺序","link":"#启动顺序","children":[]}],"relativePath":"linux-directory.md","lastUpdated":1673773212000}'),e={name:"linux-directory.md"},p=l(`<h1 id="linux目录结构" tabindex="-1">Linux目录结构 <a class="header-anchor" href="#linux目录结构" aria-hidden="true">#</a></h1><p>Linux目录树的主要部分有<code>/</code>、<code>/usr</code>、<code>/var</code>、<code>/home</code>等等。 下面是一个典型的Linux目录结构如下：</p><h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\`-- /               # 根目录</span></span>
