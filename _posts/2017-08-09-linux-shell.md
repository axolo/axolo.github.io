...
![基础知识]({{ site.url }}/files/linux-shell-01.jpg)
![文件目录]({{ site.url }}/files/linux-shell-02.jpg)
![文本处理]({{ site.url }}/files/linux-shell-03.jpg)
![Shell脚本1]({{ site.url }}/files/linux-shell-04.jpg)
![Shell脚本2]({{ site.url }}/files/linux-shell-05.jpg)
![Shell脚本3]({{ site.url }}/files/linux-shell-06.jpg)
