---
title: Docker、kubernetes和Apache Mesos之间的正确关系
time: 2018-04-29
layout: post
categories: DevOps
...
![Docker结构]({{ site.url }}/files/kubernetes-docker-mesos-docker.png)
...
![kubernetes结构]({{ site.url }}/files/kubernetes-docker-mesos-kubernetes.png)
...
![Mesos结构]({{ site.url }}/files/kubernetes-docker-mesos-mesos.png)
