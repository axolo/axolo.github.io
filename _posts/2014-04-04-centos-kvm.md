...
![centos-kvm-openstack]({{ site.url }}/fiels/centos-kvm-openstack.png)
...
![network-brige]({{ site.url }}/fiels/centos-kvm-network-brige.png)
...
![virt-manager客户端]({{ site.url }}/fiels/centos-kvm-virt-manager-client.png)
...
![安装virt-manager]({{ site.url }}/fiels/centos-kvm-virt-manager-install.png)

![连接KVM服务器]({{ site.url }}/fiels/centos-kvm-virt-manager-connection.png)

![虚拟机配置]({{ site.url }}/fiels/centos-kvm-vm.png)
